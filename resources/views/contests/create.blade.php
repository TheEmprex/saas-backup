...
<div class="container mx-auto p-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">{{ $rating->comment }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('ratings.contests.store', $rating) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="reason" rows="4" class="mt-1 block w-full border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"></textarea>
                @error('reason')
            ...
            <div class="mb-4">
                ...
                <textarea name="evidence" rows="4" class="mt-1 block w-full border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"></textarea>
                @error('evidence')
                    <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                @enderror
            </div>
