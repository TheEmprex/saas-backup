        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center">
                ...
                <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-blue-100">
                    Connect with professional managers, chatters, and agencies to grow your OnlyFans Ecosystem business
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    @else
                        <a href="{{ route('custom.login') }}" class="inline-flex items-center px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-200">
                            Login
                        </a>
                        <a href="{{ route('custom.register') }}" class="inline-flex items-center px-8 py-4 bg-yellow-400 text-blue-900 rounded-lg font-semibold hover:bg-yellow-300 transition-colors duration-200 shadow-lg">
                            Get Started
                        </a>
                    @endauth
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        ...
        <div class="mb-16">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Browse through different types of professionals and find the perfect match for your OnlyFans Ecosystem business needs.</p>
            </div>
